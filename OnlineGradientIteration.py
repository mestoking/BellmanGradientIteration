...
import time
import CUtility
class onlineGradientIRL(object):
    def __init__(self, n_actions, n_states, transitionProbability,
                 featureMatrix,discount,learning_rate,trajectory,epochs,method,approx_level,b_level):
    ...
    def gradientIterationIRL(self):
        print "online gradient iteration irl"
        ...
        for s,a,r in self.trajectory:
           ...
           # Values and Gradients
            ...
            expected_sum=np.zeros((d_states,))
            ...
            for i in range(self.n_states):
                ...
                for j in range(self.n_actions):
                    ...
                    for k in range(self.n_states):
                        ...
                        d_Q+=self.transitionProbability[i,j,k]*(self.rewardGradient(i)+self.discount*V_Gradients[k,:])
